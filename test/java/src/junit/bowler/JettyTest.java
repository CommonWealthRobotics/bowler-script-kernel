...
public class JettyTest {
	...
	// } catch (Exception ex) {
	// com.neuronrobotics.sdk.common.Log.error("User not logged in, test can not
	// run");
	// }
	...
	// com.neuronrobotics.sdk.common.Log.error("Serving " +
	// indexOfTutorial.getParent());
	...
	//
	// @Test
	// public void test() throws InvalidRemoteException, TransportException,
