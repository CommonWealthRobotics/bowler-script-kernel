...
public class VoiceTest {
	...
	public void test() {
		...
		BowlerKernel.speak("we are the borg; resistance is futile", 100, // rate
				0, // slur
				300, // voice
				1, // echo
				0.4 // volume
		);
		BowlerKernel.speak("An echoing voice in a stadium", 300, // rate
				0, // slur
				300, // voice
				0.5, // echo
				1 // volume
		...
		////
		BowlerKernel.speak("The robot voice of starscream", 100, // rate
				90, // slur
				200, // voice
				1, // echo
				1 // volume
