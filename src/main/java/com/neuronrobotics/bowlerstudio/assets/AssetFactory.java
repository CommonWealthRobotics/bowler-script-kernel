...
public class AssetFactory {
	...
	public static File loadFile(String file) throws Exception {
		return ScriptingEngine.fileFromGit(getGitSource(), // git repo, change this if you fork this demo
				getAssetRepoBranch(), file// File from within the Git repo
		);
	}
	...
	public static void writeImage(Image img, File file) {
		...
		javafx.scene.image.WritablePixelFormat<ByteBuffer> format = javafx.scene.image.PixelFormat
				.getByteBgraInstance();
