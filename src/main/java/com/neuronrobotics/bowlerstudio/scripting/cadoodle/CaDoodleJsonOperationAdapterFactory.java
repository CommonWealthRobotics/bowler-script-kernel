...
public class CaDoodleJsonOperationAdapterFactory implements TypeAdapterFactory {
	...
	public CaDoodleJsonOperationAdapterFactory() {
		...
		registerType("ExtrudeSurface", ExtrudeSurface.class);
		registerType("Fillet", FilletChamfer.class);
		registerType("Group", Group.class);
		registerType("Hide", Hide.class);
		registerType("LinearDistribution", LinearDistribution.class);
		...
		registerType("SetMaterial", SetMaterial.class);
