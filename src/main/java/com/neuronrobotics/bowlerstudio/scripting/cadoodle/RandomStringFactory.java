...
public class RandomStringFactory {
	...
	public static String[] adjectives = {
		    ...
		    "Thriving", "Burgeoning", "Prolific",  "Teeming",
		    ...
		    "Effulgent",  "Resplendent", "Splendid", "Magnificent",
	...
	public static String[] creaturesMachines = {
		    ...
		    "Gargoyle", "Teleporter",  "Forcefield",
		    ...
		    "Troll",  "Gnome",  "Leprechaun",
		    "Hyperpod", "Fairy", "Gyrocar", "Elf", "Ornithopter",
		     "Hoversuit", "Specter", "Levitator", "Phantom",
