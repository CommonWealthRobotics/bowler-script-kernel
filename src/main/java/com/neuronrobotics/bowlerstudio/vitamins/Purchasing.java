...
public class Purchasing {
	...
	public static void saveDatabase(String type) throws Exception {
		...
		try {
			ScriptingEngine.pushCodeToGit(getGitRpoDatabase(), // git repo, change this if you fork this demo
			...
			com.neuronrobotics.sdk.common.Log
					.error("You need to fork " + getGitRpoDatabase() + " to have permission to save");
	...
	public static void setParameter(String type, String id, String parameterName, PurchasingData parameter)
			throws Exception {
	...
	public static HashMap<String, HashMap<String, PurchasingData>> getDatabase(String type) {
		if (databaseSet.get(type) == null) {
			...
			File f;
			try {
				f = ScriptingEngine.fileFromGit(getGitRpoDatabase(), // git repo, change this if you fork this demo
				...
				HashMap<String, HashMap<String, PurchasingData>> database = gson.fromJson(jsonString,
						TT_mapStringString);
				if (database == null) {
	...
	public static ArrayList<String> listVitaminTypes() {
		...
		File folder;
		try {
			folder = ScriptingEngine.fileFromGit(getGitRpoDatabase(), // git repo, change this if you fork this demo
