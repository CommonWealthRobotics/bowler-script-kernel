...
public interface IMobileBaseUI {
	 ...
	 *
	 * @param fileEngineRunByName
	 *            The file that was running when the exception occurred
	 * @param ex
	 *            the stack trace for file names of open files, or for open or
	 *            executed file names
	 */
	...
	/**
	 * Highlight the given list of CSGs. This should not change the CSG, just
	 * highlight it.
	 *
	 * @param selectedCsg
	 *            the list to highlight NULL is used as a clear highlights
	 */
